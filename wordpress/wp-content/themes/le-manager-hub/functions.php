...
function lmh_theme_assets(){
 $home=is_front_page() && !get_query_var('lmh_view') && !isset($_GET['lmh_verify']);
 $verify=isset($_GET['lmh_verify']);
 if(!$home){$theme_ver=wp_get_theme()->get('Version');$css_ver=@filemtime(get_template_directory().'/assets/v5.css')?:$theme_ver;$js_ver=@filemtime(get_template_directory().'/assets/js/site.js')?:$theme_ver;wp_enqueue_style('lmh-style',get_stylesheet_uri(),[],$theme_ver);wp_enqueue_style('lmh-v5',get_template_directory_uri().'/assets/v5.css',['lmh-style'],$css_ver);$qr_ver=@filemtime(get_template_directory().'/assets/js/vendor/qrcode.min.js')?:$theme_ver;wp_enqueue_script('lmh-qrcode',get_template_directory_uri().'/assets/js/vendor/qrcode.min.js',[],$qr_ver,true);wp_enqueue_script('lmh-site',get_template_directory_uri().'/assets/js/site.js',['lmh-qrcode'],$js_ver,true);}
 if(!$verify)wp_enqueue_script('lmh-v5-bridge',get_template_directory_uri().'/assets/js/v5-bridge.js',[],'1.1.0',true);
