...
function lmh_theme_assets(){
 ...
 if(!$home){wp_enqueue_style('lmh-style',get_stylesheet_uri(),[],'1.1.0');wp_enqueue_style('lmh-v5',get_template_directory_uri().'/assets/v5.css',['lmh-style'],'1.1.0');wp_enqueue_script('lmh-site',get_template_directory_uri().'/assets/js/site.js',[],'1.1.0',true);}
